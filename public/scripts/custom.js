...
$(document).ready(function(){
    ...
    jQuery(".my-account .tabs-nav .firstLi").on("click",function(){
        if(jQuery(this).hasClass("active")){
            jQuery(".tabs-container #tab1").addClass("showForm").fadeIn();;
        };
    })

    jQuery(".my-account .tabs-nav .secondLi").on("click",function(){
        if(jQuery(this).hasClass("active")){
            jQuery(".tabs-container #tab2").addClass("showForm2").fadeIn();;
        };
    })
