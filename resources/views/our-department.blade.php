                                    ...
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="toggle-wrap style-2  ">
                                            ...
                                            <div class="toggle-container">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div id="property-slider-1" class="property-slider default">
                                                                @foreach (range(1, 2) as $index)
                                                                    <a href="/images/department/Administration-Department/{{ $index }}.jpg"
                                                                        data-background-image="/images/department/Administration-Department/{{ $index }}.jpg"
                                                            ...
                                                            <div id="property-slider-nav-1" class="property-slider-nav">
                                                                @foreach (range(1, 2) as $index)
                                                                    <div class="item">
                                                                        <img src="/images/department/Administration-Department/{{ $index }}.jpg"
                                                                            alt="">
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                                ...
                                                <p>The Administration Department at NHC plays a pivotal role in ensuring the
                                                    smooth and efficient operation of the Corporation by overseeing a
                                                    diverse range of functions. This includes managing day-to-day
                                                    operations, supervising staff, and ensuring the availability of
                                                    necessary equipment and office supplies. The department also plays a
                                                    crucial role in policy development and implementation, shaping the
                                                    strategic direction of the Corporation. It oversees Human Resources
                                                    operations, ensuring proper staffing and management of employee records,
                                                    works closely with the Accounts Department to ensure compliance with
                                                    financial regulations and budget management and manages the Registry
                                                    Section, ensuring the confidentiality and security of records. This
                                                    department also maintains the physical plant and equipment for optimal
                                                    functionality and security. In addition, it facilitates effective
                                                    communication within the organization and provides support and guidance
                                                    to all departments and sections in achieving organizational objectives.

                                                </p>
                                            </div>
                                        </div>
                                        <div class="toggle-wrap style-2">
                                            <span class="trigger "><a href="#"> Housing Management Section
                                                    <i class="sl sl-icon-plus"></i></a></span>
                                            <div class="toggle-container">
                                                <div class="container">
                                                    <div class="row margin-bottom-50">
                                                        <div class="col-md-6">
                                                            <img src="/images/department/Housing/1.jpg" alt=""
                                                                class="item mfp-gallery">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <img src="/images/department/Housing/2.jpg" alt=""
                                                                class="item mfp-gallery">
                                                        </div>
                                                    </div>
                                                </div>
                                                <p>The Housing Management Section oversees the reception and processing of
                                                    all rental unit applications, house spot allocations, tenancy changes,
                                                    and management of select commercial areas within our properties. Its
                                                    core responsibilities encompass conducting thorough investigations into
                                                    the social status and physical environment of applicants, resulting in
                                                    comprehensive reports submitted for review by the Tenants’ Committee.
                                                    Notably, in recent Housing Estate developments, the department has
                                                    prioritized accommodation for individuals with physical challenges,
                                                    underscoring our commitment to inclusivity and accessibility. In
                                                    addition, the department's responsibilities include creating rental
                                                    accounts for allocated spots and units, as well as handling accounts for
                                                    designated commercial areas. By regularly compiling reports, the
                                                    department offers insights into occupancy trends, financial performance,
                                                    and other relevant metrics, thereby enabling informed decision-making
                                                    processes.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="toggle-wrap style-2  ">
                                            <span class="trigger ">
                                                <a href="#"> Customer Service Department
                                                    <i class="sl sl-icon-plus"></i></a>
                                            </span>
                                            <div class="toggle-container">
                                                <div class="container">
                                                    <div class="row margin-bottom-50">
                                                        <div class="col-md-12">
                                                            <img src="/images/department/Customer-Service-Department/1.jpg"
                                                                alt="" class="item mfp-gallery">
                                                        </div>
                                                    </div>
                                                </div>
                                                <p>The Customer Service Department assumes a crucial role within our
                                                    organization, entrusted with raising awareness of the Corporation’s
                                                    products and nurturing relationships with lending institutions and
                                                    potential clients. Serving as the pivotal gateway where dreams of
                                                    property ownership materialize, the department executes several
                                                    essential functions to facilitate this journey. Its duties encompass the
                                                    facilitation of site visits and the management of lot/property
                                                    allocation to successful applicants, along with the provision of
                                                    personalized assistance throughout. Furthermore, the department is
                                                    responsible for initiating sales transactions, ensuring the preparation
                                                    of offer documents, and overseeing deposit processing to ensure
                                                    compliance.
                                                </p>
                                            </div>
                                            <div class="toggle-wrap style-2  ">
                                                ...
                                                <div class="toggle-container">
                                                    <div class="container">
                                                        <div class="row margin-bottom-50">
                                                            <div class="col-md-12">
                                                                <img src="/images/department/Contact-Centre/1.jpg"
                                                                    alt="" class="item mfp-gallery">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <p>The Contact Centre is the Corporation’s centralized hub for
                                                        communication and support, offering residents and prospective
                                                        tenants a convenient way to get in touch. The Contact Center is
                                                        equipped with friendly representatives who are ready to assist you.
                                                        They are available to handle any inquiries you may have, help
                                                        resolve issues, and provide information on a wide range of housing
                                                        matters, such as rental applications, loans, and property
                                                        maintenance. The Contact Center plays a crucial role in providing
                                                        prompt and effective responses to inquiries, resulting in improved
                                                        customer satisfaction and the development of strong and positive
                                                        relationships. The Contact Center is committed to providing
                                                        outstanding service and support to our residents and stakeholders,
                                                        whether it be through phone, email, or online chat. Our goal is to
                                                ...
                                                <div class="toggle-wrap style-2">
                                                    ...
                                                    <div class="toggle-container">
                                                        <div class="container">
                                                            <div class="row margin-bottom-50">
                                                                <div class="col-md-12">
                                                                    <img src="/images/department/Legal-Department/1.jpg"
                                                                        alt="" class="item mfp-gallery">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <p>The Legal Department was established in 1972 under the purview of
                                                            the former Housing Authority. The Legal Department initially
                                                            concentrated on tasks such as mortgage preparation for the
                                                            Public Officers' Housing Loans Fund, rent arrears collection,
                                                            and conveyance preparation. Over time, as the Corporation
                                                            adapted to meet contemporary demands, the Legal Department
                                                            underwent substantial transformation to align with the needs of
                                                            a modern organization. Its key responsibilities now include
                                                            drafting Agreements for the sale/rental of lots/property,
                                                            crafting contracts for the contractors involved in the
                                                            Corporation’s various projects, drafting and reviewing
                                                            employment contracts, and pursuing loans and rental arrears.
                                                            This department also provides comprehensive legal counsel to all
                                                            departments to ensure compliance with legal requirements and
                                                    ...
                                                    <div class="toggle-wrap style-2">
                                                        ...
                                                        <div class="toggle-container">
                                                                ...
                                                                <div class="row margin-bottom-50">
                                                                    @foreach (range(1, 8) as $image)
                                                                        <div class="col-md-4 col-sm-6 mb-4">
                                                                            <div class="card">
                                                                                <a href="/images/department/Maintenance-Section/{{ $image }}.jpg"
                                                                                    class="mfp-gallery"> &nbsp; &nbsp;
                                                                                    &nbsp; &nbsp; &nbsp; &nbsp;
                                                                                    <img src="/images/department/Maintenance-Section/{{ $image }}.jpg"
                                                                                        alt=""
                                                            ...
                                                            <p>The Maintenance Section is responsible for establishing and
                                                                implementing Building and Estate Maintenance Systems to
                                                                ensure the efficient maintenance of buildings, grounds, and
                                                                sewage systems. The primary responsibility of this
                                                                department is to effectively manage and coordinate
                                                                maintenance activities, such as building maintenance, sewage
                                                                system upkeep, and depot management. Strict adherence to
                                                                industry standards and regulations is imperative. Its
                                                                responsibilities include overseeing well pumping, choke
                                                                cleaning, effluent disposal, and recommending well digging
                                                                for sewage purposes. Furthermore, the department conducts
                                                                regular surveys to evaluate customer satisfaction in
                                                                relation to maintenance services, promptly addressing any
                                                                identified areas for improvement to uphold elevated levels
                                                                of customer satisfaction.
                                                            </p>
                                                        </div>
                                                        <div class="toggle-wrap style-2">
                                                            <span class="trigger ">
                                                                <a href="#"> Technical Department
                                                            ...
                                                            <div class="toggle-container">
                                                                <div class="container">
                                                                    <div class="row margin-bottom-50">
                                                                        <div class="col-md-12">
                                                                            <img src="/images/department/Technical-Department/1.jpg"
                                                                                alt="" class="item mfp-gallery">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <p>The Technical Department has a significant role in the
                                                                    National Housing Corporation as its primary focus is on
                                                                    improving the quality, functionality, and value of our
                                                                    properties through strategic planning and execution. Its
                                                                    responsibilities include overseeing renovation projects
                                                                    to improve housing units and common areas, such as
                                                                    upgrading fixtures, installing energy-efficient systems,
                                                                    and enhancing security measures. The department also
                                                                    identifies and prioritizes capital improvement projects,
                                                                    including roof replacements and facade upgrades, to
                                                                    enhance overall property quality and value. Furthermore,
                                                                    it oversees the coordination of relationships with
                                                                    external vendors, contractors, and service providers
                                                                    engaged in maintenance, repairs, and construction
                                                                    projects, ensuring thorough management of procurement,
                                                            ...
                                                            <div class="toggle-wrap style-2">
                                                                <span class="trigger ">
                                                                    <a href="#"> The Accounts Department
                                                                        <i class="sl sl-icon-plus"></i></a>
                                                                </span>
                                                                <div class="toggle-container">
                                                                    <div class="container">
                                                                        <div class="row margin-bottom-50">
                                                                            <div class="col-md-6">
                                                                                <img src="/images/department/Accounts-Department/1.jpg"
                                                                                    alt=""
                                                                                    class="item mfp-gallery">
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <img src="/images/department/Accounts-Department/2.jpg"
                                                                                    alt=""
                                                                                    class="item mfp-gallery">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <p>The Accounts Department plays a pivotal role in
                                                                        advancing the financial and strategic objectives of
                                                                        the Corporation, ensuring sound fiscal management
                                                                        and compliance with international standards. Its
                                                                        responsibilities encompass overseeing cash
                                                                        management, purchase orders, and payments, ensuring
                                                                        the accuracy and timeliness of financial
                                                                        transactions, and adhering to internal controls
                                                                        aligned with International Accounting Standards for
                                                                        asset protection and risk mitigation. Additionally,
                                                                        the department handles budget preparation and
                                                                        monitoring, payroll processing, and account
                                                                        management related to loans, rent, and commercial
                                                                        activities. The primary responsibility of the Loans
                                                                        Department is the management of the Corporation’s
                                                                        loan portfolio by facilitating loan access to
                                                                        low-income individuals. Its key responsibility
                                                                        includes receiving and processing applications for
                                                                        loans, ensuring thorough evaluation and adherence to
                                                                ...
                                                                <div class="toggle-wrap style-2">
                                                                    ...
                                                                    <div class="toggle-container">
                                                                        <div class="container">
                                                                            <div class="row margin-bottom-50">
                                                                                <div class="col-md-12">
                                                                                    <img src="/images/department/Human-Resources-Department/1.jpg"
                                                                                        alt=""
                                                                                        class="item mfp-gallery">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <p>The Human Resources Department is dedicated to
                                                                            ensuring the Corporation has access to a
                                                                            proficient, skilled, and passionate workforce,
                                                                            which is vital for the successful accomplishment
                                                                            of its overarching goals and objectives. Its
                                                                            core responsibilities include the careful
                                                                            maintenance of personnel records, effective
                                                                            management of leave, and facilitation of
                                                                            processes related to retiring awards
                                                                            documentation. Additionally, the department
                                                                            oversees grievance handling, industrial
                                                                            relations, counseling, health and safety
                                                                            matters, training initiatives, and disciplinary
                                                                            proceedings. The Human Resources Department
                                                                            assumes a significant responsibility in
                                                                            facilitating effective communication among
                                                                            employees, management, and the Board of
                                                                            Directors, thereby creating a work environment
                                                                            that is both harmonious and conducive to the
                                                                            organization's overall achievements.

                                                                        </p>
                                                                    </div>
                                                                    <div class="toggle-wrap style-2  "><span
                                                                            class="trigger "><a href="#"> Special
                                                                                Projects Unit
                                                                                <i class="sl sl-icon-plus"></i></a></span>
                                                                        <div class="toggle-container">
                                                                            <div class="container">
                                                                                <div class="row margin-bottom-50">
                                                                                    <div class="col-md-4">
                                                                                        <img src="/images/department/Special-Projects-Unit/1.jpg"
                                                                                            alt=""
                                                                                            class="item mfp-gallery">
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <img src="/images/department/Special-Projects-Unit/2.jpg"
                                                                                            alt=""
                                                                                            class="item mfp-gallery">
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <img src="/images/department/Special-Projects-Unit/3.jpg"
                                                                                            alt=""
                                                                                            class="item mfp-gallery">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <p>The Special Projects Unit manages and
                                                                                oversees the Hurricane Elsa Rebuild/Repair
                                                                                program, ensuring efficient project
                                                                                execution and adherence to timelines, as
                                                                                well as serving as a liaison with clients
                                                                                affected by the hurricane, offering support
                                                                                and guidance throughout the
                                                                                repair/rebuilding process. To ensure
                                                                                effective project management, the department
                                                                                maintains close partnerships with
                                                                                contractors, subcontractors, and skilled
                                                                                artisans. This unit plays a role in
                                                                                maintaining the Corporation's estates in the
                                                                                southern division of the island. It executes
                                                                                a comprehensive Preventative Property
                                                                                Maintenance Program, which includes safety
                                                                                checks, cleaning, rodent control, garbage
                                                                                disposal, gardening, landscaping, and asset
                                                                                repairs, in order to guarantee the
                                                                                properties, remain in optimal condition.

                                                                            </p>
                                                                        </div>
                                                                        <div class="toggle-wrap style-2  "><span
                                                                                class="trigger "><a href="#">
                                                                                    Registry Section
                                                                                    <i
                                                                            ...
                                                                            <div class="toggle-container">
                                                                                <div class="container">
                                                                                    <div class="row margin-bottom-50">
                                                                                        <div class="col-md-12">
                                                                                            <img src="/images/department/Registry-Section/1.jpg"
                                                                                                alt=""
                                                                                                class="item mfp-gallery">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <p>The Registry Section serves as the
                                                                                    central repository for all essential
                                                                                    documents and records pertaining to the
                                                                                    Corporation’s properties and
                                                                                    transactions. It handles the storage and
                                                                                    retrieval of documents, ensuring they
                                                                                    remain confidential, accurate, and
                                                                                    easily accessible when required.
                                                                                    Overall, the Registry Department serves
                                                                                    as a vital administrative hub,
                                                                                    supporting the Corporation’s operations
                                                                                    and compliance efforts with meticulous
                                                                            ...
                                                                            <div class="toggle-wrap style-2  "><span
                                                                                ...
                                                                                <div class="toggle-container">
                                                                                    <div class="container">
                                                                                        <div class="row margin-bottom-50">
                                                                                            <div class="col-md-12">
                                                                                                <img src="/images/department/Security-Section/1.jpg"
                                                                                                    alt=""
                                                                                                    class="item mfp-gallery">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <p>The Security Section has the critical
                                                                                        task of guaranteeing the safety and
                                                                                        security of all personnel within our
                                                                                        building organization. Its key
                                                                                        duties include safeguarding
                                                                                        individuals and property through
                                                                                        systematic and random patrols,
                                                                                        supplemented by surveillance
                                                                                        equipment to maintain a secure
                                                                                        environment. Additionally, the
                                                                                        section monitors and regulates
                                                                                        pedestrian and vehicular traffic
                                                                                        within the compound to minimize
                                                                                        potential security risks and ensure
                                                                                        orderly movement.
                                                                                ...
                                                                                <div class="toggle-wrap style-2  "><span
                                                                                    ...
                                                                                    <div class="toggle-container">
                                                                                        <div class="container">
                                                                                            <div
                                                                                                ...
                                                                                                <div class="col-md-12">
                                                                                                    <img src="/images/department/Wardens/1.jpg"
                                                                                                        alt=""
                                                                                                        class="item mfp-gallery">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <p>The Wardens assumes
                                                                                            responsibility for the
                                                                                            management and oversight of a
                                                                                            comprehensive portfolio,
                                                                                            encompassing 47 housing and 80
                                                                                            land estates. This section
                                                                                            monitors all housing units and
                                                                                            lots by investigating disputes,
                                                                                            addressing issues of illegal
                                                                                            occupancy and squatting. Led by
                                                                                            the Senior Executive Officer
                                                                                            (Ag), Mr. Mark Broomes, and
                                                                                            supported by Senior Warden (Ag),
                                                                                            Mr. Anthony Armstrong, and Ms.
                                                                                            Wilma Jordan Warden, this
                                                                                            section is committed to
                                                                                            maintaining the integrity and
                                                                                            functionality of the
                                                                                            Corporation’s housing estates
                                                                                            with utmost professionalism and
                                                                                            diligence.

                                                                                        </p>
                                                                                    </div>
                                                                                    <div class="toggle-wrap style-2  ">
                                                                                        <span class="trigger "><a
                                                                                                href="#"> Management
                                                                                                Information System
                                                                                                Department (MIS)
                                                                                                <i
                                                                                        ...
                                                                                        <div class="toggle-container">
                                                                                            ...
                                                                                            <div class="container">
                                                                                                <div
                                                                                                    class="row margin-bottom-50">
                                                                                                    <div class="col-md-12">
                                                                                                        <img src="/images/department/MIS/1.jpg"
                                                                                                            alt=""
                                                                                                            class="item mfp-gallery">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <p>The Management Information
                                                                                                System (MIS) is pivotal to
                                                                                                the organization's
                                                                                                technological
                                                                                                ...
                                                                                                while prioritizing data
                                                                                                security. Additionally, the
                                                                                                MIS Department provides
                                                                                                essential user support by
                                                                                                troubleshooting hardware,
                                                                                                software, and connectivity
                                                                                                issues. It also implements
                                                                                                security management
                                                                                                protocols to safeguard
                                                                                                digital assets. The
                                                                                                establishment of data backup
                                                                                                and recovery plans ensures
                                                                                                business continuity. The
                                                                                                department is responsible
                                                                                                for leading Project
                                                                                                Management initiatives,
                                                                                                including overseeing system
                                                                                                upgrades, software
                                                                                                implementations, and
                                                                                                infrastructure expansions.
                                                                                                Additionally, they conduct
                                                                                                ongoing technology
                                                                                    ...
                                                                                    <br>
                                                                                    <br>
                                                                                    {{-- <div class="row margin-bottom-50" style="margin-top: 50px"> --}}
                                                                                    {{-- <div class="col-md-12"> --}}
                                                                                    {{-- <!-- Slider --> --}}
                                                                                    {{-- <div class="property-slider default"> --}}
                                                                                    {{-- @foreach (range(1, 15) as $index) --}}
                                                                                    {{-- <a href="/images/dept/{{ $index }}.jpg" data-background-image="/images/dept/{{ $index }}.jpg" class="item mfp-gallery"></a> --}}
                                                                                    {{-- @endforeach --}}
                                                                                    {{-- </div> --}}
                                                                                    {{-- <!-- Slider Thumbs--> --}}
                                                                                    ...
                                                                                    {{-- @foreach (range(1, 15) as $index) --}}
                                                                                    {{-- <div class="item"> --}}
                                                                                    {{-- <img src="/images/dept/{{ $index }}.jpg" alt=""> --}}
                                                                                    {{-- </div> --}}
                                                                                    {{-- @endforeach --}}
                                                                                    {{-- </div> --}}
                                                                                    {{-- </div> --}}
