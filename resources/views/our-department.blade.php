							...
							<div class="wpb_column vc_column_container vc_col-sm-6">
								<div class="vc_column-inner">
									<div class="wpb_wrapper">
										<h4 style="font-weight:normal;text-align:left;" class="headline margin-top-15 margin-bottom-35     "></h4>
														...
														<div class="col-md-12">
															...
															<div id="property-slider-1" class="property-slider default">
																@foreach(range(1, 2) as $index)
																	<a href="/images/department/Administration-Department/{{ $index }}.jpg" data-background-image="/images/department/Administration-Department/{{ $index }}.jpg" class="item mfp-gallery"></a>
																	@endforeach
															</div>
															<!-- Slider Thumbs-->
															<div id="property-slider-nav-1" class="property-slider-nav">
																@foreach(range(1, 2) as $index)
																	<div class="item">
																		<img src="/images/department/Administration-Department/{{ $index }}.jpg" alt="">
																	</div>
																@endforeach
															</div>
														</div>
										...
										<div class="toggle-wrap style-2">
											...
											<div class="toggle-container">
												<div class="container">
													<div class="row margin-bottom-50">
														<div class="col-md-6">
															<img src="/images/department/Housing/1.jpg" alt="" class="item mfp-gallery">
														</div>
														<div class="col-md-6">
															<img src="/images/department/Housing/2.jpg" alt="" class="item mfp-gallery">
														</div>
													</div>
												</div>
...
<i class="sl sl-icon-plus"></i></a>
											...
											<div class="toggle-container">
												<div class="container">
													<div class="row margin-bottom-50">
														<div class="col-md-12">
															<img src="/images/department/Customer-Service-Department/1.jpg" alt="" class="item mfp-gallery">
														</div>
													</div>
												</div>
...
<i class="sl sl-icon-plus"></i></a>
												...
												<div class="toggle-container">
													<div class="container">
														<div class="row margin-bottom-50">
															<div class="col-md-12">
																<img src="/images/department/Contact-Centre/1.jpg" alt="" class="item mfp-gallery">
															</div>
														</div>
													</div>
																...
																<div class="row margin-bottom-50">
																	@foreach(range(1, 8) as $image)
																		<div class="col-md-4 col-sm-6 mb-4">
																			<div class="card">
																				<a href="/images/department/Maintenance-Section/{{ $image }}.jpg" class="mfp-gallery"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
																					<img src="/images/department/Maintenance-Section/{{ $image }}.jpg" alt="" class="card-img-top img-fluid" style="height: 300px; object-fit: cover;">
																				</a>
																			</div>
																		</div>
																	@endforeach
...
<i class="sl sl-icon-plus"></i></a>
																...
																<div class="toggle-container">
																	<div class="container">
																		<div class="row margin-bottom-50">
																			<div class="col-md-6">
																				<img src="/images/department/Accounts-Department/1.jpg" alt="" class="item mfp-gallery">
																			</div>
																			<div class="col-md-6">
																				<img src="/images/department/Accounts-Department/2.jpg" alt="" class="item mfp-gallery">
																			</div>
																		</div>
																	</div>
...
<i class="sl sl-icon-plus"></i></a></span>
																	<div class="toggle-container">
																		<div class="container">
																			<div class="row margin-bottom-50">
																				<div class="col-md-12">
																					<img src="/images/department/Human-Resources-Department/1.jpg" alt="" class="item mfp-gallery">
																				</div>
																			</div>
																		</div>
																	...
																	<div class="toggle-wrap style-2  "><span class="trigger "><a href="#"> Special Projects Unit
<i class="sl sl-icon-plus"></i></a></span><div class="toggle-container">
																			<div class="container">
																				<div class="row margin-bottom-50">
																					<div class="col-md-4">
																						<img src="/images/department/Special-Projects-Unit/1.jpg" alt="" class="item mfp-gallery">
																					</div>
																					<div class="col-md-4">
																						<img src="/images/department/Special-Projects-Unit/2.jpg" alt="" class="item mfp-gallery">
																					</div>
																					<div class="col-md-4">
																						<img src="/images/department/Special-Projects-Unit/3.jpg" alt="" class="item mfp-gallery">
																					</div>
																				</div>
																			</div>
																			<p>The Special Projects Unit manages and oversees the Hurricane Elsa Rebuild/Repair program, ensuring efficient project execution and adherence to timelines, as well as serving as a liaison with clients affected by the hurricane, offering support and guidance throughout the repair/rebuilding process. To ensure effective project management, the department maintains close partnerships with contractors, subcontractors, and skilled artisans. This unit plays a role in maintaining the Corporation's estates in the southern division of the island. It executes a comprehensive Preventative Property Maintenance Program, which includes safety checks, cleaning, rodent control, garbage disposal, gardening, landscaping, and asset repairs, in order to guarantee the properties, remain in optimal condition.

																			</p>
																		</div>
																		<div class="toggle-wrap style-2  "><span class="trigger "><a href="#"> Registry Section
<i class="sl sl-icon-plus"></i></a></span><div class="toggle-container">
																				<div class="container">
																					<div class="row margin-bottom-50">
																						<div class="col-md-12">
																							<img src="/images/department/Registry-Section/1.jpg" alt="" class="item mfp-gallery">
																						</div>
																					</div>
																				</div>
																			...
																			<div class="toggle-wrap style-2  "><span class="trigger "><a href="#"> Security Section
<i class="sl sl-icon-plus"></i></a></span><div class="toggle-container">
																					<div class="container">
																						<div class="row margin-bottom-50">
																							<div class="col-md-12">
																								<img src="/images/department/Security-Section/1.jpg" alt="" class="item mfp-gallery">
																							</div>
																						</div>
																					</div>
																				...
																				<div class="toggle-wrap style-2  "><span class="trigger "><a href="#"> Wardens
<i class="sl sl-icon-plus"></i></a></span><div class="toggle-container">
																						<div class="container">
																							<div class="row margin-bottom-50">
																								<div class="col-md-12">
																									<img src="/images/department/Wardens/1.jpg" alt="" class="item mfp-gallery">
																								</div>
																							</div>
																						</div>
																					...
																					<div class="toggle-wrap style-2  "><span class="trigger "><a href="#"> Management Information System Department (MIS)
<i class="sl sl-icon-plus"></i></a></span><div class="toggle-container">

																							<div class="container">
																								<div class="row margin-bottom-50">
																									<div class="col-md-12">
																										<img src="/images/department/MIS/1.jpg" alt="" class="item mfp-gallery">
																									</div>
																								</div>
																							</div>
	...
	<a href="/contact" class="flip-banner parallax" data-background="images/back.jpg" data-color="#" data-color-opacity="0.1" data-img-width="2500" data-img-height="1600">
...
@endsection
<style>
	accordion-content, .style-2 .toggle-wrap {
