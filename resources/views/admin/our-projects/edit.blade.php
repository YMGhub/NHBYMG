    ...
    <div class="containerOut">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg containerInner">
                ...
                @endif
                <form action="{{ route('admin.our-projects.update', $content->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="mb-6">
                        <input value="{{ $content->id }}" name="id_ourprojects" id="id_ourprojects" type="hidden">
                            ...
                            <div class="container">
                                ...
                                <div class="flex">
                                    @foreach ($content1 as $image)
                                        <div class="col-md-3">
                                            <img src="{{ url('/storage/' . $image->path) }}" width="100px">
                                            <label>
