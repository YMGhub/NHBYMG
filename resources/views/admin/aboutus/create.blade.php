            ...
            <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg containerInner">
                ...
                <form action="{{ route('admin.aboutus.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 labelSection" for="section1">About Us</label>
                        <textarea class="form-control" id="section1" name="section1">{{ old('section1') }}</textarea>
                    </div>
                    <br>
                    <div class="form-group">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 labelSection" for="section2">Mission</label>
                        <textarea class="form-control" id="section2" name="section2">{{ old('section2') }}</textarea>
                    </div>
                    <br>
                    <div class="form-group">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 labelSection" for="section3">Vision</label>
