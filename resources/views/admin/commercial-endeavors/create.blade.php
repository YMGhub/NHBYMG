<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
            {{ __('Create Commercial Endeavors') }}
        </h2>
    </x-slot>
    ...
    <div class="containerOut">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg containerInner">
                ...
                <form class="" action="{{ route('admin.commercial-endeavors.store') }}" method="POST"
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-1">
                        ...
                        <div>
                            ...
                            <input type="text" id="name_commercial" name="name_commercial"
