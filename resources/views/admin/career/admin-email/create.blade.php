<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
            {{ __('Create Admin Email Form Career') }}
        </h2>
    </x-slot>
    ...
    <div class="containerOut">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg containerInner">
                ...
                <form class="" action="{{ route('admin.career.admin-email.store') }}" method="POST"
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-1">
                        ...
                        <div>
                            <label for=""
                                ...
                                Form</label>
                            <input type="email" id="admin_email_form_career" name="admin_email_form_career"
