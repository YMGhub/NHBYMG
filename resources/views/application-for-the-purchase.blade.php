                                            ...
                                            <div class="col-md-12 hideArea">
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label style="color:#fff"><b>.</b></label>
                                                            <input name="applicant_surname" type="text"
                                                                id="applicant_surname" placeholder="Surname"
                                                                required="required" />
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div>
                                                                <label style="color:#fff"><b>.</b></label>
                                                                <input name="applicant_maiden" type="text"
                                                                    id="applicant_maiden" placeholder="Maiden" />
                                                            </div>
                                                        </div>
                        ...
                        if (ClientIDValid == 0) {
                            ...
                            if (data.errorMessage) {
                                ...
                                if (isDataEmpty(parsedData)) {
                                    ...
                                    //field Saludation
                                    jQuery("#salutation").val(Salutation)
                                        .css({
                                            'pointer-events': 'none',
                                    ...
                                    //field Surname
                                    jQuery("#applicant_surname").val(Surname).css({
                                            'pointer-events': 'none',
                                            'background-color': '#f5f5f5',
                                            'cursor': 'not-allowed'
                                    });
                        ...
                        .then(data => {
                            ...
                            if (data.errorMessage) {
                                ...
                                if (isDataEmpty(parsedData)) {
                                    ...
                                    //field Salutation
                                    jQuery("#coapplicant_salutation").val(Salutation);
                                    ...
                                    //field MiddleName
                                    jQuery("#coapplicant_middle").val(MiddleName)
                                        .css({
                                            'pointer-events': 'none',
                                            'background-color': '#f5f5f5',
                                            'cursor': 'not-allowed'
                                    ...
                                    //field SurName
                                    jQuery("#coapplicant_surname").val(Surname)
                                        .css({
                                            'pointer-events': 'none',
                                            'background-color': '#f5f5f5',
                                            'cursor': 'not-allowed'
                                    ...
                                    jQuery("#coapplicant_gender").val(Gender).css({
                                        'pointer-events': 'none',
                                        'background-color': '#f5f5f5',
                                        'cursor': 'not-allowed'
                                    });;
                            ...
                            .then(data => {
                                ...
                                if (data.errorMessage) {
                                    ...
                                    if (isDataEmpty2(parsedData)) {
                                        ...
                                        //field MiddleName
                                        jQuery("#coapplicant_maiden_name").val(MaidenName).css({
                                            'pointer-events': 'none',
                                            'background-color': '#f5f5f5',
                                            'cursor': 'not-allowed'
                                        });;
